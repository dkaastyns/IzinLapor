  ...
  <AuthenticatedLayout>
    ...
    <div class="max-w-7xl mx-auto space-y-7">
      ...
      <div class="grid grid-cols-2 lg:grid-cols-5 gap-4 lg:gap-5">
        ...
        >
          ...
          <div class="relative z-10 mt-auto">
            ...
            <p class="text-4xl lg:text-5xl font-black text-gray-900 tracking-tight leading-none group-hover:text-violet-900 transition-colors duration-300">
        ...
        >
          ...
          <div class="relative z-10 mt-auto">
            ...
            <p class="text-4xl lg:text-5xl font-black text-gray-900 tracking-tight leading-none group-hover:text-amber-900 transition-colors duration-300">
              {{ animatedStats.pending.toLocaleString() }}
            </p>
          </div>
        </div>
        ...
        >
          ...
          <div class="relative z-10 mt-auto">
            ...
            <p class="text-4xl lg:text-5xl font-black text-gray-900 tracking-tight leading-none group-hover:text-blue-900 transition-colors duration-300">
        ...
        >
          ...
          <div class="relative z-10 mt-auto">
            ...
            <p class="text-4xl lg:text-5xl font-black text-gray-900 tracking-tight leading-none group-hover:text-emerald-900 transition-colors duration-300">
        ...
        >
          <div class="absolute top-0 right-0 bottom-0 w-[55%] bg-rose-50/80 rounded-l-[5rem] transition-transform duration-700 group-hover:scale-110 origin-right pointer-events-none" />
          <div class="absolute top-0 -right-4 bottom-0 w-[55%] bg-rose-100/40 rounded-l-[5rem] transition-transform duration-700 delay-75 group-hover:scale-125 origin-right pointer-events-none" />
          ...
          <div class="relative z-10 mt-auto">
            <p class="text-[9px] font-extrabold text-gray-400 uppercase tracking-widest mb-1 group-hover:text-rose-500 transition-colors duration-300">
              DITOLAK
            </p>
            <p class="text-4xl lg:text-5xl font-black text-gray-900 tracking-tight leading-none group-hover:text-rose-900 transition-colors duration-300">
              {{ animatedStats.rejected.toLocaleString() }}
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="ds-rating-strip">
        <div class="absolute inset-0 bg-gradient-to-r from-amber-500 via-orange-400 to-emerald-400 rounded-2xl" />
        <div class="absolute -top-8 -right-8 w-32 h-32 rounded-full bg-white/20 blur-xl" />
        <div class="absolute -bottom-4 -left-4 w-24 h-24 rounded-full bg-white/20 blur-lg" />
            ...
            <div class="flex flex-col gap-1">
              <div class="flex items-center gap-0.5">
                <template v-if="stats.avg_rating">
                  <svg
                    v-for="n in getStars(stats.avg_rating).full"
                    :key="'f'+n"
                  ...
                  <svg
                    v-if="getStars(stats.avg_rating).half"
                    class="w-4 h-4 text-white/50 drop-shadow"
                    fill="currentColor"
                    viewBox="0 0 20 20"
                  ><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" /></svg>
                  <svg
                    v-for="n in getStars(stats.avg_rating).empty"
                    :key="'e'+n"
                    class="w-4 h-4 text-white/25 drop-shadow"
                    fill="currentColor"
                    viewBox="0 0 20 20"
                  ><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" /></svg>
                </template>
              ...
              <p class="text-white/80 text-xs font-bold">
                {{ t('average_rating') }} · {{ stats.rated_count || 0 }} {{ t('reviews') }}
              </p>
            </div>
          </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        <div class="ds-panel p-6 flex flex-col">
          <div class="flex items-center justify-between mb-5">
            <h3 class="ds-widget-title">
              <span class="ds-widget-dot bg-gradient-to-r from-violet-500 to-indigo-500" />
              {{ t('by_category') }}
            </h3>
            <button
              ...
              >
                <div class="flex items-center justify-between mb-1.5">
                  <div class="flex items-center gap-2 min-w-0">
                    <div
                      class="w-2.5 h-2.5 rounded-full flex-shrink-0 bg-gradient-to-br shadow-sm"
                      :class="getCategoryColor(catIdx)"
                    />
                  ...
                  <div class="flex items-center gap-2">
                    <span
                      v-if="cat.recent_complaints_count > 0"
                      class="text-[9px] font-black text-rose-500 bg-rose-50 border border-rose-100 px-1.5 py-0.5 rounded-md"
                    >+{{ cat.recent_complaints_count }}</span>
          ...
          <p
            v-if="!showAllCategories && categories?.length > 4"
            class="text-[10px] text-gray-400 font-medium mt-3 text-center"
          >
        ...
        <div class="ds-panel p-6 flex flex-col">
          <div class="flex items-center justify-between mb-5">
            <h3 class="ds-widget-title">
              <span class="ds-widget-dot bg-gradient-to-r from-indigo-500 to-indigo-600" />
              {{ t('worst_facility') }}
            </h3>
            <button
            ...
            >
              ...
              <svg
                class="w-3.5 h-3.5 transition-transform duration-300"
                :class="showAllFacilities ? 'rotate-180' : ''"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              ><path
              ...
              >
                <div class="flex items-center justify-between mb-1.5">
                  <div class="flex items-center gap-2 min-w-0 flex-1">
                    ...
                    <span
                      class="text-[13px] font-semibold truncate max-w-[120px] group-hover:text-primary-600 transition-colors"
                      :class="index === 0 ? 'text-indigo-700 font-bold' : 'text-gray-700'"
                    >{{ facility.location }}</span>
                  </div>
                  <div class="flex items-center gap-2">
                    <span
                      v-if="facility.recent_count > 0"
                      class="text-[9px] font-black text-rose-500 bg-rose-50 border border-rose-100 px-1.5 py-0.5 rounded-md flex items-center gap-0.5"
                    >
                      <svg
                        class="w-2.5 h-2.5"
                        fill="none"
          ...
          <div
            v-else
            class="text-center py-6 flex-1 flex items-center justify-center"
          >
          ...
          <!-- Collapsed count hint -->
          <p
            v-if="!showAllFacilities && worstFacilities?.length > 4"
            class="text-[10px] text-gray-400 font-medium mt-3 text-center"
          >
        ...
        <div class="ds-panel p-6 flex flex-col">
          <h3 class="ds-widget-title mb-5">
            <span class="ds-widget-dot bg-gradient-to-r from-emerald-500 to-teal-500" />
            Ringkasan Cepat
          </h3>
          <div class="space-y-3 flex-1">
            ...
            <div class="ds-quick-item group">
              ...
              <div class="flex-1 min-w-0">
                ...
                <p class="text-[10px] text-gray-400 font-medium">
                  {{ stats.rated_count || 0 }} ulasan masuk
                </p>
              </div>
      ...
      <div
        id="complaints-table"
        class="ds-panel overflow-hidden scroll-mt-6"
      >
        <!-- Table Header -->
        <div class="flex items-center justify-between px-7 py-5 border-b border-gray-100/80">
          <div>
            <h3 class="text-sm font-extrabold text-gray-900 uppercase tracking-wider flex items-center gap-2.5">
              <span class="w-2.5 h-2.5 rounded-full bg-gradient-to-r from-violet-500 to-purple-500 animate-pulse shadow-sm shadow-violet-300" />
            ...
            <p class="text-xs text-gray-400 mt-0.5 font-medium">
              Live feed laporan kerusakan fasilitas
            </p>
          </div>
          <Link
            :href="route('admin.complaints')"
            class="ds-link-arrow group"
          >
            {{ t('manage_full') }}
            <svg
        ...
        <div class="p-6 lg:p-7">
          ...
          <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
            ...
            <div
              v-if="!activeFilter"
              class="relative w-full sm:w-72 group"
            >
              <svg
                class="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400 group-focus-within:text-primary-500 transition-colors duration-300"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
          ...
          <div
            v-else-if="filteredComplaints.length > 0 || isSearching"
            class="relative overflow-x-auto min-h-[250px]"
          >
              ...
              >
                ...
                >
                    ...
                    <div class="flex items-center gap-3">
                      <div class="relative">
                        ...
                        <span
                          ...
                          class="absolute -top-1 -right-1 w-3 h-3 rounded-full bg-gradient-to-br from-amber-400 to-red-500 border-2 border-white shadow-sm animate-pulse"
                        />
                      </div>
                      <div class="flex flex-col">
                  ...
                  <td class="py-3.5 px-4 max-w-[220px]">
                    <p class="text-sm text-gray-700 font-medium truncate group-hover:text-primary-700 transition-colors">
                      {{ complaint.title }}
                    </p>
          ...
          >
            ...
            <div class="relative z-10 transition-transform duration-500 group-hover:-translate-y-1">
              ...
              <p class="text-primary-800/70 text-sm font-medium mb-8 max-w-sm mx-auto leading-relaxed group-hover:text-primary-800 transition-colors">
                Kami belum menemukan laporan kerusakan dengan kriteria yang Anda cari.
              </p>
              <button
                ...
                @click="activeFilter = null; searchQuery = ''"
              >
                {{ t('show_all') }}
              </button>
            </div>
          ...
          <template v-if="!activeFilter">
            <div
              v-if="recentComplaints?.links?.length > 3"
              class="flex justify-between items-center mt-8 pb-2"
            >
              ...
              <div class="flex gap-1.5">
                <template
                  v-for="(link, index) in recentComplaints.links"
                  :key="index"
                >
                  <button
                    v-if="link.url"
    ...
    <Teleport to="body">
      ...
      >
        <div
          v-if="showDetail"
          class="fixed inset-0 z-[100] flex items-start justify-center overflow-y-auto bg-black/20 backdrop-blur-sm"
          @click.self="showDetail = false"
        >
          <div
            class="relative z-10 w-full max-w-3xl mx-4 my-8 bg-white rounded-[2rem] shadow-2xl overflow-hidden ring-1 ring-black/5"
            @click.stop
          >
            <div class="p-6 md:p-8 max-h-[85vh] overflow-y-auto custom-scrollbar">
              ...
              <div class="flex items-start justify-between mb-6">
                <div>
                  <p class="text-[10px] font-bold text-primary-400 uppercase tracking-[0.15em] mb-1">
                    DETAIL LAPORAN
                  </p>
                  ...
                  <p class="text-xs text-gray-400 mt-0.5">
                    ID <span class="font-bold text-primary-500">#RPT-{{ String(detailComplaint?.id).padStart(4, '0') }}</span> · {{ formatDateFull(detailComplaint?.created_at) }}
                  </p>
                </div>
                <button
              ...
              <div class="grid grid-cols-3 gap-4 p-4 bg-gray-50/80 rounded-xl mb-6">
                ...
                <div>
                  ...
                  <span
                    :class="'badge badge-' + detailComplaint?.status"
                    class="mt-1 inline-block"
                  >{{ statusLabel[detailComplaint?.status] }}</span>
                </div>
              </div>
              ...
              <div class="flex items-start gap-3 mb-6 p-4 bg-gray-50 rounded-xl">
                ...
                <div>
                  <p class="text-sm font-bold text-gray-800">
                    {{ detailComplaint?.location }}
                  </p>
                  <p
                    v-if="detailComplaint?.location_detail"
                    class="text-xs text-gray-400 mt-0.5"
                  >
                    {{ detailComplaint?.location_detail }}
                  </p>
                </div>
              </div>
              ...
              <div
                ...
                class="bg-primary-50/80 border border-primary-100 rounded-xl p-5 mb-6"
              >
              ...
              <div class="flex gap-3 pt-4 border-t border-gray-100">
                <Link
                  :href="route('admin.complaints')"
                  class="flex-1 flex items-center justify-center gap-2 px-4 py-3 bg-gradient-to-r from-primary-500 to-primary-600 text-white rounded-xl font-bold text-sm shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all duration-300"
                >
                  <svg
                    class="w-4 h-4"
                    fill="none"
                ...
                <button
                  class="px-6 py-3 bg-white border border-gray-200 text-gray-600 rounded-xl font-bold text-sm hover:bg-gray-50 transition-all duration-300"
                  @click="showDetail = false"
                >
                  Tutup
                </button>
    ...
    <Teleport to="body">
      <Transition name="lightbox">
        ...
        >
          <button
            class="absolute top-6 right-6 w-12 h-12 flex items-center justify-center rounded-full bg-white/20 hover:bg-white/30 text-white font-bold transition-all"
            @click="closeLightbox"
          >
            ✕
          </button>
          <button
            ...
            class="absolute left-6 w-14 h-14 flex items-center justify-center rounded-full bg-white/20 hover:bg-white/30 text-white text-2xl transition-all"
            @click="navLightbox(-1)"
          >
            ‹
          </button>
          <img
            ...
            class="max-w-[85vw] max-h-[80vh] object-contain rounded-2xl shadow-xl select-none"
          >
          <button
            v-if="lightboxImages.length > 1"
            class="absolute right-6 w-14 h-14 flex items-center justify-center rounded-full bg-white/20 hover:bg-white/30 text-white text-2xl transition-all"
            @click="navLightbox(1)"
          >
            ›
          </button>
