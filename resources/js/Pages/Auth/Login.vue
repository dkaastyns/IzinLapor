    ...
    <div class="w-full px-4 sm:px-0">
      <div class="mb-10 text-center sm:text-left">
        ...
        <p class="text-[15px] text-gray-400 font-medium leading-relaxed motion-preset-slide-right motion-duration-500 motion-delay-100">
          Silakan masuk untuk melanjutkan akses ke IzinLapor.
        </p>
      </div>

      <div
        v-if="status"
        class="mb-5 text-sm font-medium text-green-600 bg-green-50/80 border border-green-100 p-4 rounded-xl"
      >
        {{ status }}
      </div>
      ...
      >
        ...
        <div class="pt-2">
          ...
          >
            ...
            <span
              v-if="!form.processing"
              class="relative z-10 transition-all duration-300 ease-in-out group-hover:-translate-x-1"
            >Masuk Sekarang</span>
            <span
              v-else
            ...
            <svg
              v-if="!form.processing"
              class="w-5 h-5 relative z-10 transition-all duration-300 ease-in-out group-hover:translate-x-1"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
