    ...
    <GuestLayout>
        ...
        <div class="w-full">
            <div class="mb-10 text-center sm:text-left">
                ...
                <p class="text-[15px] text-gray-400 font-medium leading-relaxed motion-preset-slide-right motion-duration-500 motion-delay-100">Lengkapi data diri Anda di bawah ini untuk memulai.</p>
            </div>
            ...
            <form @submit.prevent="submit" class="space-y-6">
                ...
                <div class="group">
                    <div class="flex justify-between items-center mb-2 px-1">
                        <label for="name" class="text-[12px] font-black text-indigo-950/70 uppercase tracking-[0.1em] group-focus-within:text-primary-600 transition-colors">Nama Lengkap</label>
                    </div>
                    <div class="relative">
                    ...
                    <InputError class="mt-1.5 ml-4" :message="form.errors.name" />
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    ...
                    <div class="group">
                        <div class="flex justify-between items-center mb-2 px-1">
                            <label for="phone" class="text-[12px] font-black text-indigo-950/70 uppercase tracking-[0.1em] group-focus-within:text-primary-600 transition-colors">Nomor Telepon</label>
                        </div>
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-5 flex items-center pointer-events-none transition-colors group-focus-within:text-primary-500 text-gray-400">
                                <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <InputError class="mt-1.5 ml-4" :message="form.errors.phone" />
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    ...
                    <div class="group">
                        <div class="flex justify-between items-center mb-2 px-1">
                            <label for="password_confirmation" class="text-[12px] font-black text-indigo-950/70 uppercase tracking-[0.1em] group-focus-within:text-primary-600 transition-colors">Konfirmasi</label>
                        </div>
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-5 flex items-center pointer-events-none transition-colors group-focus-within:text-primary-500 text-gray-400">
                                <svg class="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                        ...
                        <InputError class="mt-1.5 ml-4" :message="form.errors.password_confirmation" />
                    </div>
                </div>
                ...
                <div class="pt-2">
                    ...
                    >
                        ...
                        <span v-if="!form.processing" class="relative z-10 transition-transform duration-300 group-hover:-translate-x-1">Daftar Akun Sekarang</span>
                ...
                <div class="text-center pt-2">
                    <p class="text-[13.5px] text-gray-400 font-medium">
                        Sudah punya akun?
                        <Link :href="route('login')" class="text-primary-600 font-black hover:underline underline-offset-4 transition">
                            Login di sini
                        </Link>
                    </p>
                </div>
