  ...
  <AuthenticatedLayout>
    ...
    <div class="riwayat-page max-w-6xl mx-auto space-y-8">
        ...
        <div class="p-8 sm:p-10 relative z-10 flex flex-col justify-between h-full">
          ...
          <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-5 mb-10">
            ...
            <Link
              ...
              class="inline-flex items-center justify-center gap-2 bg-white/10 hover:bg-white/20 text-white border border-white/30 backdrop-blur-md text-sm font-black px-7 py-3.5 rounded-xl transition-all duration-300 hover:-translate-y-1 shadow-[0_8px_20px_-6px_rgba(0,0,0,0.2)] flex-shrink-0 self-start lg:self-center"
            >
              <svg
          ...
          <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 lg:gap-6">
            ...
            <div class="relative flex flex-col items-center justify-center gap-2 p-5 bg-white/10 backdrop-blur-md border border-white/20 rounded-[1.25rem] hover:bg-white/20 hover:border-white/40 transition-all duration-700 ease-[cubic-bezier(0.23,1,0.32,1)] group hover:-translate-y-2 shadow-[0_4px_15px_rgba(0,0,0,0.1)] hover:shadow-[0_15px_30px_-5px_rgba(0,0,0,0.3)] cursor-default overflow-hidden">
              <!-- Shine Sweep -->
              <div class="absolute inset-y-0 -inset-x-[150%] bg-gradient-to-r from-transparent via-white/20 to-transparent transform -skew-x-[30deg] -translate-x-[200%] group-hover:duration-1000 group-hover:translate-x-[200%] transition-transform ease-[cubic-bezier(0.23,1,0.32,1)] z-0 pointer-events-none" />
              ...
              <div class="flex items-center gap-4 w-full relative z-10">
                <div class="relative w-12 h-12 flex-shrink-0 transition-transform duration-700 ease-[cubic-bezier(0.23,1,0.32,1)] group-hover:scale-110 group-hover:rotate-[15deg]">
                  <svg
                    class="w-full h-full -rotate-90 group-hover:-rotate-[75deg] transition-all duration-700 ease-[cubic-bezier(0.23,1,0.32,1)]"
                    viewBox="0 0 48 48"
                  >
                    <circle
                      cx="24"
                      ...
                      r="20"
                      fill="none"
                      class="stroke-white/10 group-hover:stroke-white/20 transition-colors duration-700"
                      stroke-width="3"
                    />
                    <circle
                      cx="24"
                      ...
                      r="20"
                      fill="none"
                      stroke="url(#gradTotalGlass)"
                      stroke-width="3"
                      stroke-linecap="round"
                      stroke-dasharray="126"
                      stroke-dashoffset="0"
                      class="drop-shadow-[0_0_8px_rgba(233,213,255,0)] group-hover:drop-shadow-[0_0_8px_rgba(233,213,255,0.6)] transition-all duration-700 ease-out"
                    />
                    <defs><linearGradient
                      id="gradTotalGlass"
                      x1="0"
                  ...
                  <div class="absolute inset-0 flex items-center justify-center text-purple-200 transition-transform duration-700 group-hover:-rotate-[15deg] group-hover:scale-[1.15]">
                    <svg
                      class="w-5 h-5 drop-shadow-md group-hover:text-white transition-colors duration-500"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    ><path
                ...
                <div class="flex-1 text-left">
                  <p class="text-2xl lg:text-3xl font-black text-white leading-none drop-shadow-sm group-hover:scale-110 origin-left transition-transform duration-500 ease-[cubic-bezier(0.23,1,0.32,1)] group-hover:text-purple-100">
                    {{ statusCounts.total }}
                  </p>
                  <p class="text-[10px] font-bold text-white/70 uppercase tracking-widest mt-1 group-hover:text-white/90 transition-colors duration-300">
                    Total
                  </p>
                </div>
              </div>
            ...
            <div class="relative flex flex-col items-center justify-center gap-2 p-5 bg-white/10 backdrop-blur-md border border-white/20 rounded-[1.25rem] hover:bg-white/20 hover:border-white/40 transition-all duration-700 ease-[cubic-bezier(0.23,1,0.32,1)] group hover:-translate-y-2 shadow-[0_4px_15px_rgba(0,0,0,0.1)] hover:shadow-[0_15px_30px_-5px_rgba(0,0,0,0.3)] cursor-default overflow-hidden">
              ...
              <div class="flex items-center gap-4 w-full relative z-10">
                <div class="relative w-12 h-12 flex-shrink-0 transition-transform duration-700 ease-[cubic-bezier(0.23,1,0.32,1)] group-hover:scale-110 group-hover:rotate-[15deg]">
                  ...
                  >
                    ...
                    <circle
                      ...
                      r="20"
                      fill="none"
                      stroke="url(#gradPendingGlass)"
                      stroke-width="3"
                      stroke-linecap="round"
                      :stroke-dasharray="126"
                      :stroke-dashoffset="statusCounts.total > 0 ? 126 - (statusCounts.pending / statusCounts.total) * 126 : 126"
                      class="drop-shadow-[0_0_8px_rgba(251,191,36,0)] group-hover:drop-shadow-[0_0_8px_rgba(251,191,36,0.6)] transition-all duration-700 ease-out"
                    />
                    <defs><linearGradient
                      id="gradPendingGlass"
                      x1="0"
                ...
                <div class="flex-1 text-left">
                  <p class="text-2xl lg:text-3xl font-black text-white leading-none drop-shadow-sm group-hover:scale-110 origin-left transition-transform duration-500 ease-[cubic-bezier(0.23,1,0.32,1)] group-hover:text-amber-100">
            ...
            <div class="relative flex flex-col items-center justify-center gap-2 p-5 bg-white/10 backdrop-blur-md border border-white/20 rounded-[1.25rem] hover:bg-white/20 hover:border-white/40 transition-all duration-700 ease-[cubic-bezier(0.23,1,0.32,1)] group hover:-translate-y-2 shadow-[0_4px_15px_rgba(0,0,0,0.1)] hover:shadow-[0_15px_30px_-5px_rgba(0,0,0,0.3)] cursor-default overflow-hidden">
              ...
              <div class="flex items-center gap-4 w-full relative z-10">
                <div class="relative w-12 h-12 flex-shrink-0 transition-transform duration-700 ease-[cubic-bezier(0.23,1,0.32,1)] group-hover:scale-110 group-hover:rotate-[15deg]">
                  ...
                  >
                    ...
                    <circle
                      ...
                      r="20"
                      fill="none"
                      stroke="url(#gradProcessingGlass)"
                      stroke-width="3"
                      stroke-linecap="round"
                      :stroke-dasharray="126"
                      :stroke-dashoffset="statusCounts.total > 0 ? 126 - (statusCounts.processing / statusCounts.total) * 126 : 126"
                      class="drop-shadow-[0_0_8px_rgba(96,165,250,0)] group-hover:drop-shadow-[0_0_8px_rgba(96,165,250,0.6)] transition-all duration-700 ease-out"
                    />
                    <defs><linearGradient
                      id="gradProcessingGlass"
                      x1="0"
                      y1="0"
                      x2="1"
                      y2="1"
                ...
                <div class="flex-1 text-left">
                  <p class="text-2xl lg:text-3xl font-black text-white leading-none drop-shadow-sm group-hover:scale-110 origin-left transition-transform duration-500 ease-[cubic-bezier(0.23,1,0.32,1)] group-hover:text-blue-100">
            ...
            <div class="relative flex flex-col items-center justify-center gap-2 p-5 bg-white/10 backdrop-blur-md border border-white/20 rounded-[1.25rem] hover:bg-white/20 hover:border-white/40 transition-all duration-700 ease-[cubic-bezier(0.23,1,0.32,1)] group hover:-translate-y-2 shadow-[0_4px_15px_rgba(0,0,0,0.1)] hover:shadow-[0_15px_30px_-5px_rgba(0,0,0,0.3)] cursor-default overflow-hidden">
              ...
              <div class="flex items-center gap-4 w-full relative z-10">
                <div class="relative w-12 h-12 flex-shrink-0 transition-transform duration-700 ease-[cubic-bezier(0.23,1,0.32,1)] group-hover:scale-110 group-hover:rotate-[15deg]">
                  ...
                  >
                    ...
                    <circle
                      ...
                      r="20"
                      fill="none"
                      stroke="url(#gradResolvedGlass)"
                      stroke-width="3"
                      stroke-linecap="round"
                      :stroke-dasharray="126"
                      :stroke-dashoffset="statusCounts.total > 0 ? 126 - (statusCounts.resolved / statusCounts.total) * 126 : 126"
                      class="drop-shadow-[0_0_8px_rgba(52,211,153,0)] group-hover:drop-shadow-[0_0_8px_rgba(52,211,153,0.6)] transition-all duration-700 ease-out"
                    />
                    <defs><linearGradient
                      id="gradResolvedGlass"
                      x1="0"
                      y1="0"
                      x2="1"
                      y2="1"
                ...
                <div class="flex-1 text-left">
                  <p class="text-2xl lg:text-3xl font-black text-white leading-none drop-shadow-sm group-hover:scale-110 origin-left transition-transform duration-500 ease-[cubic-bezier(0.23,1,0.32,1)] group-hover:text-emerald-100">
        ...
        <div class="riwayat-filter-bar shadow-sm">
          ...
          >
            <div
              ...
              class="absolute inset-0 bg-gradient-to-r from-transparent via-white/50 to-transparent -translate-x-full animate-[shine-sweep_3s_infinite] pointer-events-none z-0"
            />
            <span
              class="relative z-10 flex items-center justify-center w-6 h-6 rounded-lg backdrop-blur-md border border-white/40 shadow-sm transition-transform duration-300 group-hover:scale-110"
              :class="{
            ...
            <span
              v-if="key !== 'all'"
              class="relative z-10 riwayat-filter-count shadow-sm border border-white/50"
              :class="'count-' + cfg.color"
            >
            ...
            <span
              v-else
              class="relative z-10 riwayat-filter-count count-primary shadow-sm border border-white/50"
            >{{ statusCounts.total }}</span>
          </button>
        </div>
      </div>
      ...
      <div class="flex items-center justify-between animate-fade-in-up stagger-1 mb-2">
        ...
        <p
          v-if="complaints.total"
          class="text-[10px] font-bold text-gray-400 uppercase tracking-wider hidden sm:block"
        >
      ...
      <div
        v-if="isInitialLoad"
        class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 animate-fade-in-up stagger-2"
      >
        <div
          v-for="i in 6"
          :key="i"
          class="riwayat-card-skeleton"
        >
          <div
            class="h-1.5 rounded-full w-full mb-5"
            style="background: linear-gradient(90deg, rgba(139,92,246,0.1), rgba(244,114,182,0.1));"
          />
          <div class="flex items-center gap-3 mb-4">
            <div class="w-10 h-10 rounded-xl bg-gray-100 animate-pulse" />
            <div class="flex-1">
              <div class="h-2.5 bg-gray-100 rounded w-2/3 mb-2 animate-pulse" />
              <div class="h-2 bg-gray-50 rounded w-1/3 animate-pulse" />
            </div>
          </div>
          <div class="h-4 bg-gray-100 rounded w-4/5 mb-3 animate-pulse" />
          <div class="h-3 bg-gray-50 rounded w-1/2 mb-2 animate-pulse" />
          <div class="h-3 bg-gray-50 rounded w-2/3 mb-5 animate-pulse" />
          <div class="flex items-center justify-between pt-4 border-t border-gray-50">
            <div class="h-2.5 bg-gray-50 rounded w-1/3 animate-pulse" />
            <div class="w-8 h-8 rounded-full bg-gray-50 animate-pulse" />
          </div>
        </div>
      </div>
      ...
      >
        ...
        >
          ...
          <div
            class="riwayat-card-glow"
            :style="{ background: `radial-gradient(circle at center, ${statusColorMap[complaint.status]?.from}15, transparent 70%)` }"
          />

          <!-- Update indicator badge -->
          <div
            v-if="!complaint.notified_at && complaint.status !== 'pending'"
            class="update-ribbon shadow-lg shadow-primary-500/20"
          >
            <svg
          ...
          <div class="flex items-start justify-between gap-3 mb-4">
            <div class="flex items-center gap-3">
              <div
                class="riwayat-cat-icon transition-all duration-500 group-hover:shadow-[0_0_15px_rgba(0,0,0,0.05)]"
            ...
            <span
              ...
              class="text-[9px] py-1 px-2.5 flex-shrink-0"
            >
          ...
          <!-- Description preview -->
          <p
            v-if="complaint.description"
            class="text-xs text-gray-400 font-medium mb-4 line-clamp-2 leading-relaxed"
          >
          ...
          <div class="flex items-center justify-between pt-3.5 border-t border-gray-100/60">
            ...
            <div class="riwayat-card-arrow group-hover:translate-x-1">
              <svg
                class="w-4 h-4 text-gray-400 group-hover:text-primary-600 transition-colors duration-300"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
      ...
      >
        ...
        <button
          ...
          class="inline-flex items-center gap-2 px-6 py-3 bg-white/80 backdrop-blur-md text-primary-700 font-bold text-xs rounded-2xl border border-white/90 hover:bg-white transition-all duration-300 hover:-translate-y-0.5 shadow-sm uppercase tracking-wider relative z-10 mt-6"
      ...
      <!-- PAGINATION + COUNT -->
      <div
        v-if="!isInitialLoad && localComplaints.length > 0"
      ...
      <div
        ...
        class="flex justify-center flex-wrap gap-2 mt-2 pb-4"
      >
        <template
            ...
            <div class="p-6 md:p-10 max-h-[85vh] overflow-y-auto custom-scrollbar">
              ...
              <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
                ...
                <aside class="md:col-span-4 space-y-6">
                  ...
                  <section
                    v-if="selectedComplaint.status !== 'rejected'"
                    class="bg-white p-7 rounded-[1.5rem] shadow-sm border border-[#ede6f0]"
                  >
                    <h2 class="text-[11px] font-extrabold text-[#625d67] uppercase tracking-[0.2em] mb-7 flex items-center gap-2">
                      <svg
                        class="w-4 h-4 text-[#685688]"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                      ><path
                    ...
                    <div class="relative ml-2">
                      ...
                      <div class="absolute left-[-1px] top-2 bottom-4 w-[3px] bg-[#f3ebf5] rounded-full" />
                      <!-- Active Vertical Line -->
                      <div
                        class="absolute left-[-1px] top-2 w-[3px] bg-gradient-to-b from-[#685688] to-[#9d7bb3] rounded-full transition-all duration-1000 ease-in-out" 
                        :style="{ height: selectedComplaint.status === 'resolved' ? '100%' : (selectedComplaint.status === 'processing' ? '50%' : '0%') }"
                      />

                      <!-- Step 1: Diterima -->
                      <div class="relative pl-7 pb-8 group">
                        <div class="absolute left-[-5px] top-1 w-4 h-4 rounded-full border-[3px] border-white bg-[#685688] shadow-sm ring-1 ring-[#685688]/20 z-10 transition-transform group-hover:scale-110" />
                                                
                        <h4 class="text-[14px] font-bold text-[#35313a] leading-none mb-1">
                          Laporan Masuk
                        </h4>
                        ...
                        <p class="text-[11px] text-gray-500 leading-relaxed font-medium">
                          Berhasil tercatat di sistem informasi
                        </p>
                      </div>
                      ...
                      <div class="relative pl-7 pb-8 group">
                        <div
                          class="absolute left-[-5px] top-1 w-4 h-4 rounded-full border-[3px] border-white transition-all shadow-sm ring-1 z-10 group-hover:scale-110"
                          :class="['processing', 'resolved'].includes(selectedComplaint.status) ? 'bg-[#685688] ring-[#685688]/20' : 'bg-[#eadef7] ring-transparent'"
                        />
                                                     
                        <!-- Active Ping Effect -->
                        <div
                          v-if="selectedComplaint.status === 'processing'"
                          class="absolute left-[-5px] top-1 w-4 h-4 rounded-full border-[3px] border-white bg-[#685688] animate-ping opacity-60 z-0"
                        />
                                                
                        <h4
                          class="text-[14px] font-bold leading-none mb-1 transition-colors" 
                          :class="['processing', 'resolved'].includes(selectedComplaint.status) ? 'text-[#35313a]' : 'text-gray-400'"
                        >
                          Diproses oleh Tim
                        </h4>
                                                
                        <div
                          v-if="selectedComplaint.status === 'processing' || selectedComplaint.status === 'resolved'"
                          class="flex items-center gap-2 text-xs text-[#625d67] font-medium mb-1.5"
                        >
                          <svg
                            class="w-3.5 h-3.5"
                            fill="none"
                        ...
                        <div
                          v-if="selectedComplaint.status === 'processing' && selectedComplaint.progress"
                          class="mt-3 w-full h-2 bg-[#f3ebf5] rounded-full overflow-hidden shadow-inner border border-white/50"
                        >
                          <div
                            class="h-full bg-gradient-to-r from-[#685688] to-[#9d7bb3] rounded-full transition-all duration-1000 relative"
                            :style="`width: ${selectedComplaint.progress}%`"
                          >
                            <div class="absolute inset-0 bg-[image:linear-gradient(45deg,rgba(255,255,255,0.2)_25%,transparent_25%,transparent_50%,rgba(255,255,255,0.2)_50%,rgba(255,255,255,0.2)_75%,transparent_75%,transparent)] bg-[length:1rem_1rem] animate-[progress-stripes_1s_linear_infinite]" />
                          </div>
                        </div>
                        <div
                          v-if="selectedComplaint.status === 'processing' && selectedComplaint.progress"
                      ...
                      <div class="relative pl-7 group">
                        <div
                          class="absolute left-[-5px] top-1 w-4 h-4 rounded-full border-[3px] border-white transition-all shadow-sm ring-1 z-10 group-hover:scale-110"
                          :class="selectedComplaint.status === 'resolved' ? 'bg-[#10b981] ring-[#10b981]/20' : 'bg-[#eadef7] ring-transparent'"
                        />
                                                     
                        <!-- Active Ping Effect for Resolved -->
                        <div
                          v-if="selectedComplaint.status === 'resolved'"
                          class="absolute left-[-5px] top-1 w-4 h-4 rounded-full border-[3px] border-white bg-[#10b981] animate-ping opacity-40 z-0"
                        />

                        <h4
                          class="text-[14px] font-bold leading-none mb-1 transition-colors" 
                          :class="selectedComplaint.status === 'resolved' ? 'text-[#35313a]' : 'text-gray-400'"
                        >
                          Tugas Selesai
                        </h4>
                        ...
                        <div
                          v-if="selectedComplaint.status === 'resolved'"
                          class="flex items-center gap-2 text-xs text-[#10b981] font-bold mb-1.5"
                        >
                          <svg
                            class="w-3.5 h-3.5"
                            fill="none"
                        ...
                        <p
                          class="text-[11px] transition-colors leading-relaxed font-medium"
                          :class="selectedComplaint.status === 'resolved' ? 'text-gray-500' : 'text-gray-300'"
                        >
                          Penanganan telah diselesaikan dengan baik
                        </p>
                      </div>
                    </div>
                    ...
                    <div
                      v-if="selectedComplaint.status === 'processing' && selectedComplaint.estimated_completion_date"
                      class="mt-6 pt-5 border-t border-dashed border-[#ede6f0]"
                    >
                      <div class="bg-[#f8f1fa] rounded-xl p-3.5 flex items-center gap-3">
                        ...
                        <div>
                          <p class="text-[10px] text-[#625d67] font-bold uppercase tracking-wider mb-0.5">
                            Estimasi Selesai
                          </p>
                          <p class="text-xs text-[#35313a] font-extrabold">
                            {{ formatEstDate(selectedComplaint.estimated_completion_date) }}
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  <section
                    v-else
                    class="bg-gradient-to-br from-[#fff1f2] to-[#ffe4e6] p-7 rounded-[1.5rem] border border-[#fecdd3] shadow-sm relative overflow-hidden group"
                  >
                    ...
                    <div class="relative z-10 flex flex-col items-center text-center">
                      <div class="w-14 h-14 bg-rose-100 text-rose-500 rounded-full flex items-center justify-center mb-4 shadow-inner shadow-rose-200/50 relative transform transition-transform duration-300 hover:scale-110">
                        <!-- Ping effect -->
                        <div class="absolute inset-0 rounded-full bg-rose-400 animate-ping opacity-25" />
                        <svg
                      ...
                      <h3
                        class="text-rose-700 font-extrabold text-lg mb-1.5"
                        style="font-family: 'Manrope', sans-serif;"
                      >
                        Laporan Ditolak
                      </h3>
                      <p class="text-rose-600/80 text-xs font-semibold px-2 mb-5">
                        Laporan ini tidak dapat diproses lebih lanjut oleh sistem.
                      </p>
                      ...
                      <div class="bg-white/70 p-4 rounded-xl border border-rose-100/60 w-full backdrop-blur-md shadow-sm relative text-left transition-all hover:bg-white/90">
                        <span class="block text-[10px] font-extrabold text-rose-500 uppercase tracking-widest mb-2 flex items-center gap-1.5"><svg
                          class="w-3.5 h-3.5"
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                        ...
                        /></svg>ALASAN PENOLAKAN</span>
                        <p class="text-[#35313a] text-[13px] font-bold leading-relaxed italic border-l-2 border-rose-400 pl-3">
                          "{{ selectedComplaint.admin_response || 'Laporan tidak relevan atau merupakan duplikat. Hubungi admin untuk detail lebih lanjut.' }}"
                        </p>
                  ...
                  >
                    ...
                    >
                      ...
                      <template v-else>
                        ...
                        <p
                          v-if="ratingValue > 0"
                          class="text-center text-xs font-bold text-[#685688] mb-4"
                        >
                          {{ ratingEmojis[ratingValue] }} {{ ratingLabel(ratingValue) }}
                        </p>
                        <textarea
                        ...
                        <button
                          ...
                          @click.stop="submitRating(selectedComplaint)"
                        >
