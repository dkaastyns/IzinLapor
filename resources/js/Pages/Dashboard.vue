...
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <h1 class="text-xl font-bold text-primary-900">{{ t('dashboard') }}</h1>
        </template>
        ...
        <div class="max-w-6xl mx-auto space-y-8">
            ...
            <div class="relative overflow-hidden rounded-[2rem] bg-[#533483] animate-fade-in-up border border-white/10 shadow-2xl group">
                ...
                <div class="p-8 sm:p-10 relative z-10 flex flex-col md:flex-row items-center justify-between gap-8 h-full">
                    <div class="w-full md:max-w-[65%]">
                        ...
                        >
                            <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2.5"><path stroke-linecap="round" stroke-linejoin="round" d="M12 4v16m8-8H4"/></svg>
                            Buat Laporan Baru
                        </Link>
                    </div>
                    ...
                    <div class="hidden md:flex relative z-10 w-64 h-44 items-center justify-center group/ill">
                        <div class="w-full h-full relative animate-float">
                            <!-- Back shadow glow -->
                            <div class="absolute inset-0 bg-white/20 blur-3xl opacity-0 group-hover:opacity-40 group-hover:scale-125 transition-all duration-1000 rounded-full pointer-events-none"></div>
                            ...
                            <div class="absolute inset-0 bg-gradient-to-br from-white/30 to-white/5 rounded-2xl backdrop-blur-xl border border-white/40 shadow-[0_20px_50px_rgba(0,0,0,0.3)] transform -rotate-3 group-hover:rotate-0 group-hover:scale-105 group-hover:-translate-y-1 group-hover:-translate-x-1 transition-all duration-[800ms] ease-[cubic-bezier(0.23,1,0.32,1)] delay-[100ms] overflow-hidden flex flex-col front-glass-card group-hover:shadow-[0_30px_60px_rgba(0,0,0,0.5)]">
                                ...
                                <div class="h-8 bg-gradient-to-b from-white/20 to-transparent border-b border-white/20 flex items-center px-4 gap-2 relative z-10">
                                    <div class="w-2.5 h-2.5 rounded-full bg-rose-400 drop-shadow-md shadow-[0_0_8px_rgba(251,113,133,0.8)]"></div>
                                    <div class="w-2.5 h-2.5 rounded-full bg-amber-400 drop-shadow-md shadow-[0_0_8px_rgba(251,191,36,0.8)]"></div>
                                    <div class="w-2.5 h-2.5 rounded-full bg-emerald-400 drop-shadow-md shadow-[0_0_8px_rgba(52,211,153,0.8)]"></div>
                                </div>
                                <div class="p-4 flex-1 flex flex-col gap-3 relative z-10">
                                    <div class="flex gap-3 items-center">
                                        ...
                                        <div class="flex-1 flex flex-col justify-center gap-2">
                                            <div class="w-3/4 h-2.5 rounded bg-white/50"></div>
                                            <div class="w-1/2 h-2.5 rounded bg-white/30"></div>
                                        </div>
                                    </div>
                                    <div class="w-full h-16 rounded-xl bg-gradient-to-t from-white/20 to-white/5 flex items-end p-2.5 gap-2.5 mt-auto border border-white/20 shadow-inner">
                                        <div class="w-1/3 h-[60%] bg-gradient-to-t from-white/40 to-white/10 rounded-sm shadow-[0_0_15px_rgba(255,255,255,0.3)] transform origin-bottom hover:scale-y-110 transition-transform cursor-pointer"></div>
                                        <div class="w-1/3 h-[40%] bg-gradient-to-t from-white/30 to-white/5 rounded-sm transform origin-bottom hover:scale-y-110 transition-transform cursor-pointer"></div>
            ...
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-5">
                ...
                <div class="bg-white rounded-[1.5rem] p-6 shadow-[0_4px_24px_-8px_rgba(0,0,0,0.08)] hover:shadow-[0_8px_32px_-8px_rgba(0,0,0,0.12)] transition-all animate-fade-in-up stagger-1 relative overflow-hidden flex flex-col justify-between min-h-[170px] group border border-gray-100 ds-stat-card cursor-pointer">
                    ...
                    <div class="relative z-10 mt-auto">
                        <p class="text-[9px] font-extrabold text-gray-400 uppercase tracking-widest mb-1 group-hover:text-violet-500 transition-colors duration-300">LAPORAN TERKIRIM</p>
                        <p class="text-4xl md:text-5xl font-black text-gray-900 tracking-tight leading-none group-hover:text-violet-900 transition-colors duration-300">{{ stats?.total || 0 }}</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-[1.5rem] p-6 shadow-[0_4px_24px_-8px_rgba(0,0,0,0.08)] hover:shadow-[0_8px_32px_-8px_rgba(0,0,0,0.12)] transition-all animate-fade-in-up stagger-2 relative overflow-hidden flex flex-col justify-between min-h-[170px] group border border-gray-100 ds-stat-card cursor-pointer">
                    ...
                    <div class="flex items-start justify-between relative z-10 mb-6">
                        <div class="w-11 h-11 rounded-[1.1rem] bg-amber-500 flex items-center justify-center shadow-lg shadow-amber-500/30 transition-transform duration-500 group-hover:scale-110 group-hover:-rotate-6">
                            <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                        </div>
                    ...
                    <div class="relative z-10 mt-auto">
                        ...
                        <p class="text-4xl md:text-5xl font-black text-gray-900 tracking-tight leading-none group-hover:text-amber-900 transition-colors duration-300">{{ stats?.pending || 0 }}</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-[1.5rem] p-6 shadow-[0_4px_24px_-8px_rgba(0,0,0,0.08)] hover:shadow-[0_8px_32px_-8px_rgba(0,0,0,0.12)] transition-all animate-fade-in-up stagger-3 relative overflow-hidden flex flex-col justify-between min-h-[170px] group border border-gray-100 ds-stat-card cursor-pointer">
                    ...
                    <div class="relative z-10 mt-auto">
                        ...
                        <p class="text-4xl md:text-5xl font-black text-gray-900 tracking-tight leading-none group-hover:text-blue-900 transition-colors duration-300">{{ stats?.processing || 0 }}</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-[1.5rem] p-6 shadow-[0_4px_24px_-8px_rgba(0,0,0,0.08)] hover:shadow-[0_8px_32px_-8px_rgba(0,0,0,0.12)] transition-all animate-fade-in-up stagger-4 relative overflow-hidden flex flex-col justify-between min-h-[170px] group border border-gray-100 ds-stat-card cursor-pointer">
                    ...
                    <div class="flex items-start justify-between relative z-10 mb-6">
                        <div class="w-11 h-11 rounded-[1.1rem] bg-emerald-500 flex items-center justify-center shadow-lg shadow-emerald-500/30 transition-transform duration-500 group-hover:scale-110 group-hover:-rotate-6">
                            <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                        </div>
                    ...
                    <div class="relative z-10 mt-auto">
                        ...
                        <p class="text-4xl md:text-5xl font-black text-gray-900 tracking-tight leading-none group-hover:text-emerald-900 transition-colors duration-300">{{ stats?.resolved || 0 }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="animate-fade-in-up stagger-5">
                ...
                <div class="riwayat-section-bar mb-6">
                    <div class="flex items-center gap-3">
                        <div class="relative w-11 h-11 group cursor-default flex-shrink-0">
                            <div class="absolute top-0 right-0 w-8 h-8 rounded-xl bg-primary-400/30 transition-transform duration-300 group-hover:rotate-6 group-hover:scale-110"></div>
                            <div class="absolute bottom-0 left-0 w-9 h-9 rounded-xl bg-primary-500/20 backdrop-blur-md border border-primary-300/50 flex items-center justify-center shadow-lg transition-transform duration-300 group-hover:-translate-y-1">
                                <svg class="w-5 h-5 text-primary-600 drop-shadow-sm" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                                </svg>
                            </div>
                        </div>
                        <div>
                            <h2 class="text-base font-black text-gray-900 tracking-tight leading-tight">Riwayat Laporan</h2>
                            <p class="text-[11px] text-gray-400 font-medium">{{ allComplaints.length }} laporan ditemukan</p>
                        </div>
                    </div>
                    <Link
                ...
                <!-- Loading Skeleton -->
                <div v-if="isInitialLoad" class="grid grid-cols-1 lg:grid-cols-5 gap-5">
                    <div class="lg:col-span-3 bg-white p-5 rounded-2xl border border-gray-100 shadow-[0_2px_10px_-4px_rgba(0,0,0,0.05)] h-64 animate-pulse"></div>
                    <div class="lg:col-span-2 space-y-5 flex flex-col h-full">
                        <div class="bg-white p-5 rounded-2xl border border-gray-100 shadow-[0_2px_10px_-4px_rgba(0,0,0,0.05)] flex-1 animate-pulse min-h-[120px]"></div>
                        <div class="bg-white p-5 rounded-2xl border border-gray-100 shadow-[0_2px_10px_-4px_rgba(0,0,0,0.05)] flex-1 animate-pulse min-h-[120px]"></div>
                    </div>
                </div>
                ...
                <div v-else-if="allComplaints.length > 0" class="grid grid-cols-1 lg:grid-cols-5 gap-5 items-stretch">
                    ...
                    >
                        ...
                        <div class="w-full sm:w-[45%] h-56 sm:h-auto bg-gray-100 relative overflow-hidden flex-shrink-0">
                            ...
                            <template v-if="displayedComplaints[0].image_paths?.length > 0 || displayedComplaints[0].image_path">
                                <img :src="resolveImageUrl(displayedComplaints[0].image_paths?.[0] || displayedComplaints[0].image_path)" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
                            </template>
                            ...
                            <div v-else class="w-full h-full flex flex-col items-center justify-center bg-gradient-to-br from-indigo-50 to-indigo-100 text-indigo-300">
                                <svg class="w-16 h-16 opacity-50" fill="currentColor" viewBox="0 0 24 24"><path d="M4 4h16v16H4V4zm2 2v12h12V6H6zm2 3h8v2H8V9zm0 4h5v2H8v-2z"></path></svg>
                            </div>
                        ...
                        <div class="p-6 flex flex-col justify-between flex-1 bg-white relative">
                            ...
                            <div v-if="!displayedComplaints[0].notified_at && displayedComplaints[0].status !== 'pending'" class="absolute -top-3 right-4 bg-gradient-to-r from-indigo-500 to-indigo-600 text-white text-[9px] font-bold px-2 py-1 rounded shadow-md uppercase tracking-wider flex items-center gap-1 z-10 hidden sm:flex">
                    ...
                    <div class="lg:col-span-2 flex flex-col gap-5 h-full">
                        <template v-for="index in [1, 2]" :key="index">
                            <div v-if="displayedComplaints[index]" 
                            ...
                            >
                                <div class="absolute top-0 left-0 right-0 h-[3px] z-20" :class="displayedComplaints[index].status === 'resolved' ? 'bg-gradient-to-r from-emerald-400 to-emerald-500' : (displayedComplaints[index].status === 'pending' ? 'bg-gradient-to-r from-orange-400 to-orange-500' : 'bg-gradient-to-r from-blue-400 to-blue-500')"></div>
                                <div v-if="!displayedComplaints[index].notified_at && displayedComplaints[index].status !== 'pending'" class="absolute top-0 right-0 w-2 h-full bg-indigo-500 z-30"></div>
                                ...
                                <div class="mt-auto pt-4 border-t border-gray-50 flex items-center justify-between">
                                    ...
                                    <div v-if="displayedComplaints[index].status === 'resolved'" class="text-[9px] text-emerald-600 font-bold">
                ...
                <!-- Empty State -->
                <div v-else class="text-center py-20 px-6 relative group border border-transparent animate-fade-in-up mt-5">
                    ...
                    <div class="relative z-10 transition-transform duration-500 group-hover:-translate-y-1">
                        ...
                        <p class="text-gray-500 font-medium text-sm max-w-sm mx-auto leading-relaxed group-hover:text-gray-600 transition-colors">Belum ada laporan yang dikirimkan. Buat laporan pertamamu untuk fasilitas sekolah dan bantu kami menjadi lebih baik.</p>
                    </div>
                </div>

                <!-- Count Label -->
                <div v-if="allComplaints.length > 0" class="text-center mt-6">
                                ...
                                <aside class="md:col-span-4 space-y-6">
                                    ...
                                    <section v-if="selectedComplaint.status === 'resolved'" class="bg-white p-7 rounded-[1.5rem] shadow-lg shadow-[#dbc5fe]/20 border border-[#dbc5fe]/40">
                                        ...
                                        <div v-else @click.stop>
                                            <template v-if="!ratingForm">
                                                ...
                                                <button @click="initRatingForm(selectedComplaint)" class="w-full bg-[#f3ebf5] text-[#685688] font-bold py-3.5 rounded-xl hover:bg-[#685688] hover:text-white transition-all shadow-sm">
                                                    Berikan Penilaian
                                                </button>
                                            </template>
                                            <template v-else>
                                    ...
                                    <section class="p-4 px-2">
                                        <div class="space-y-3.5">
                                            ...
                                            <div v-if="selectedComplaint.progress > 0 || selectedComplaint.status === 'processing'" class="pt-4 mt-4 border-t border-gray-100">
                                                ...
                                                <div class="w-full bg-[#f3ebf5] rounded-full h-2.5 overflow-hidden shadow-inner border border-gray-200/50">
                                                    <div class="h-full rounded-full transition-all duration-1000 ease-out bg-gradient-to-r from-[#685688] to-[#7d516d] relative"
                                                         :style="`width: ${selectedComplaint.progress ?? 0}%`"
                                                    >
                                                        <div v-if="selectedComplaint.status === 'processing' && selectedComplaint.progress > 0 && selectedComplaint.progress < 100" class="absolute inset-0 bg-[image:linear-gradient(45deg,rgba(255,255,255,0.2)_25%,transparent_25%,transparent_50%,rgba(255,255,255,0.2)_50%,rgba(255,255,255,0.2)_75%,transparent_75%,transparent)] bg-[length:1rem_1rem] animate-[progress-stripes_1s_linear_infinite]"></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
