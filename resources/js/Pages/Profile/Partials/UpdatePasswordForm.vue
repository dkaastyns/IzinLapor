...
<template>
  <section class="bg-white/60 backdrop-blur-md rounded-[2rem] p-8 shadow-sm border border-white/60 relative group">
    ...
    <div class="absolute inset-0 bg-gradient-to-br from-primary-100/10 to-transparent rounded-[2rem] pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
    ...
    >
      ...
      <div>
        <InputLabel
          ...
          class="text-[10px] uppercase font-bold text-gray-400 tracking-widest mb-2 ml-1"
        />
        <div class="relative">
          <TextInput
            id="current_password"
          ...
          >
            ...
            ><path
              ...
              stroke-linejoin="round"
              stroke-width="2"
              d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.878 9.878L3 3m6.878 6.878l4.242 4.242M15 12a3 3 0 01-3 3m0 0l6.12 6.12"
            /></svg>
          </button>
        </div>
        <InputError
      ...
      <div class="flex flex-col-reverse sm:flex-row sm:items-center justify-end gap-4 pt-4">
        ...
        >
          <p
            ...
            class="text-sm font-bold text-emerald-600 uppercase tracking-wider text-center sm:text-left flex items-center gap-2"
          >
            <svg
              class="w-5 h-5"
              fill="none"
    ...
    >
      ...
      >
        ...
        >
          <div
            v-if="showConfirmModal"
            class="relative glass-card shadow-2xl w-full max-w-md overflow-hidden border border-white/60"
          >
            <div class="p-8 text-center">
              ...
              <h3 class="text-xl font-extrabold text-gray-900 mb-2 tracking-tight">
