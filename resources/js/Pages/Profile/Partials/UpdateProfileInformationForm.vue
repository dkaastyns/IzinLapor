  ...
  <section class="bg-white/60 backdrop-blur-md rounded-[2rem] p-8 shadow-sm border border-white/60 relative group">
      ...
      <div class="flex flex-col-reverse sm:flex-row sm:items-center justify-end gap-4 pt-4">
        ...
        >
          <p
            ...
            class="text-sm font-bold text-emerald-600 uppercase tracking-wider text-center sm:text-left"
          >
            Tersimpan.
          </p>
        </Transition>
    ...
    >
      <div class="p-8">
        ...
        <h3 class="text-xl font-extrabold text-gray-900 text-center mb-2 tracking-tight">
          Simpan Perubahan?
        </h3>
